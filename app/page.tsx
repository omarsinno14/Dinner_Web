...
export default function Home() {
  ...
  const submitMessage = async (e: FormEvent) => {
    ...
    const payload = {
      ...
      selectedFakeTime: fakeTime,
      actualTime: SITE_CONFIG.actualDinnerTime,
    ...
    try {
      ...
      else setSendError("Message failed to send. Omar’s complaint department is temporarily broken.");
    } catch {
      setSendError("Message failed to send. Omar’s complaint department is temporarily broken.");
    } finally {
      setSending(false);
    }
  };
