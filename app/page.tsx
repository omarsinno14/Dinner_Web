...
export default function Home() {
  ...
  const noMessage = SITE_CONFIG.noMessages[Math.min(Math.max(noAttempts - 1, 0), SITE_CONFIG.noMessages.length - 1)];
